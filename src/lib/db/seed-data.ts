...
const ROWS: Row[] = [
  ...
  // R4 (7 of 8)
  ["m-r4unknown", "VoidR4", 4, 809_114_301, 30, "on", 1_575_660],
...
export const REAL_STRONGHOLDS: Stronghold[] = [
  { id: "s-craftsman-6", category: "sanctum", sanctumType: "craftsman", name: "Craftsman Chancel", level: 6, coordX: 485, coordY: 602, occupier: "VOID", deathRate: 20, guardianId: "m-kitsune", governorIds: [null, null], sentryIds: [null, null, null, null, null], opensAt: hrs(-2), closesAt: hrs(4) },
  { id: "s-goldglade-5", category: "sanctum", sanctumType: "goldglade", name: "Goldglade Shrine", level: 5, coordX: 485, coordY: 712, occupier: "VOID", deathRate: 20, guardianId: "m-mvgda", governorIds: [null, null], sentryIds: [null, null, null, null, null], opensAt: hrs(3), closesAt: hrs(9) },
  { id: "s-steelstory-4", category: "sanctum", sanctumType: "steelstory", name: "Steelstory Shrine", level: 4, coordX: 354, coordY: 482, occupier: "VOID", deathRate: 20, guardianId: "m-grim", governorIds: [null, null], sentryIds: [null, null, null, null, null], opensAt: hrs(-1), closesAt: hrs(1) },
  { id: "s-goldglade-4", category: "sanctum", sanctumType: "goldglade", name: "Goldglade Shrine", level: 4, coordX: 354, coordY: 712, occupier: "VOID", deathRate: 20, guardianId: "m-lprdgddss", governorIds: [null, null], sentryIds: [null, null, null, null, null], opensAt: hrs(20), closesAt: hrs(26) },
  { id: "s-steelstory-3", category: "sanctum", sanctumType: "steelstory", name: "Steelstory Shrine", level: 3, coordX: 207, coordY: 602, occupier: "VOID", deathRate: 20, guardianId: "m-janey", governorIds: [null], sentryIds: [null, null, null, null, null], opensAt: hrs(-3), closesAt: hrs(6) },
  { id: "s-goldglade-3", category: "sanctum", sanctumType: "goldglade", name: "Goldglade Shrine", level: 3, coordX: 207, coordY: 849, occupier: "VOID", deathRate: 20, guardianId: "m-shenh", governorIds: [null], sentryIds: [null, null, null, null, null], opensAt: hrs(0.75), closesAt: hrs(7) },
